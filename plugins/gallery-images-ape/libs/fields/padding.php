...
<div class="form-horizontal">
	<div class="form-group">
	    ...
	    <div class="col-xs-6 col-sm-4"> 
	    	<div class="input-group">
      			<div class="input-group-addon"><?php _e('Left','gallery-images-ape'); ?></div>
			    <?php 
		...
		<div class="col-xs-6 col-sm-4"> 
	    	<div class="input-group">
      			<div class="input-group-addon"><?php _e('Top','gallery-images-ape'); ?></div>
			    <?php 
			    echo $field_type_object->input( array(
	...
	<div class="form-group">
		...
		<div class="col-xs-6 col-sm-4"> 
	    	<div class="input-group">
      			<div class="input-group-addon"><?php _e('Right','gallery-images-ape'); ?></div>
			    <?php 
			    echo $field_type_object->input( array(
		...
		<div class="col-xs-6 col-sm-4"> 
	    	<div class="input-group">
      			<div class="input-group-addon"><?php _e('Bottom','gallery-images-ape'); ?></div>
			    <?php 
			    echo $field_type_object->input( array(
