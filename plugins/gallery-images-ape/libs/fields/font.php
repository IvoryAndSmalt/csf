...
<div class="form-horizontal">
	...
	<div class="form-group">
	    <label class="col-sm-2 control-label" for="<?php echo $field_type_object->_id( 'enabled' ); ?>'">
	    	<?php _e( $field->args('label_enable','gallery-images-ape') ); ?>
	    </label>
	     <div class="col-sm-10">
	     	<?php
			echo 
				'<input type="checkbox" data-toggle="toggle" data-onstyle="success" class="wpape_action_element" '
				.'data-on="'.__('Show','gallery-images-ape').'" data-off="'.__('Hide','gallery-images-ape').'"' 
	  	...
	  	<div class="form-group">
	    	...
	    	<div class="col-xs-2  col-sm-2 col-md-2 col-lg-2">
				<div class="input-group">
					<span class="input-group-addon"><?php _e('Icon','gallery-images-ape'); ?></span>
			...
			<div class="col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
					<span class="input-group-addon"><?php _e('Border','gallery-images-ape'); ?></span>
					<?php echo $field_type_object->input( array(
	...
	<?php }   ?>
	  	...
	  	<div class="form-group">
	    	<div class="col-xs-offset-0 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
					<span class="input-group-addon"><?php _e('Font size','gallery-images-ape'); ?></span>
			      	<?php echo $field_type_object->input( array(
			...
			<div class="col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
		    		<span class="input-group-addon"><?php _e('Line height','gallery-images-ape'); ?></span>
				      <?php echo $field_type_object->input( array(
		...
		<div class="form-group">
	    	<div class="col-xs-offset-0 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
					<span class="input-group-addon"><?php _e('Color','gallery-images-ape'); ?></span>
					 <?php 
			...
			<div class="col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
					<span class="input-group-addon"><?php _e('Hover','gallery-images-ape'); ?></span>
					<?php 
						echo  $field_type_object->input( array(
	...
	<?php if( $field->args('icon') ){ ?>
		<div class="form-group">
	    	<div class="col-xs-offset-0 col-sm-offset-2 col-md-offset-2 col-lg-offset-2 col-xs-6 col-sm-5 col-md-5 col-lg-5">
		    	<div class="input-group">
					<span class="input-group-addon"><?php _e('Background','gallery-images-ape'); ?></span>
