...
class wpApeGalleryFieldsInit {
	...
	public function wpape_setup_admin_header(){
		echo '<div id="wpape_showInformation">'
					.__("We're really appreciate if You update gallery to",'gallery-images-ape').' '.WPAPE_GALLERY_BUTTON_PREMIUM.'.'
					.' '
					.__("It's gonna help us to create more wonderful functions.",'gallery-images-ape')
				.'</div>';
	}
	...
	public function wpape_setup_admin_scripts() {
		...
		if(!WPAPE_GALLERY_PREMIUM){
			...
			wp_localize_script( 'wpape-gallery-info', 'ape_gallery_js_text', array(
				'title' 	=> __('Gallery Ape', 'gallery-images-ape','gallery-images-ape').' :: '.WPAPE_GALLERY_BUTTON_PREMIUM,
				'close' 	=> __('Continue with free version','gallery-images-ape'),
