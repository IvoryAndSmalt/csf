...
class Gallery_Images_Ape_Init {
	...
	function load(){
		...
		wpApeGalleryHelperClass::load('modules/setup/init.php');
	}
	...
	function registerPostType(){
	    ...
	    if( 
			...
			wpApeGalleryHelperClass::writeLog("run  initAfterInstall");
	...
	function initAfterInstall(){
		...
		wpApeGalleryHelperClass::writeLog("run Flush");
	...
	function loadFiles(){
		...
		if( is_admin() ){
			wpApeGalleryHelperClass::load(array('gallery.images.library.php', 'admin.menu.php' ));
		}
