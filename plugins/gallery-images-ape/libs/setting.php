...
?>
	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<input name="<?php echo WPAPE_GALLERY_NAMESPACE.'shortcode'; ?>" id="<?php echo WPAPE_GALLERY_NAMESPACE.'shortcode'; ?>" value="<?php echo wpApeGalleryHelperClass::clearString(get_option(WPAPE_GALLERY_NAMESPACE.'shortcode', '')); ?>" class="regular-text" type="text">
				<p class="description">
