...
$interface_metabox = new_cmb2_box( array(
    ...
    'title' 		=> __( 'Interface', 'gallery-images-ape' ), 
...
$interface_metabox->add_field( array(
	'name' 			=> 	__('Click event', 'gallery-images-ape' ),
...
$interface_metabox->add_field( array(
	'name' 			=> 	__('Hover mode', 'gallery-images-ape' ),
...
$interface_metabox->add_field( array(
    'name'    		=> __( 'Fill', 'gallery-images-ape' ),
...
$interface_metabox->add_field( array(
	'name'             => __('Animation', 'gallery-images-ape' ),
...
$interface_metabox->add_field( array(
	'name' 			=> __('Title', 'gallery-images-ape' ),
			    ...
			    <div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a class="collapsed headingLinkClear" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
							<span class="glyphicon glyphicon-text-width" aria-hidden="true"></span> '.__('Image Title text styling', 'gallery-images-ape' ).'
						</a>
					</h4>
			    </div>
...
$interface_metabox->add_field( array(
	'name' 			=> __('Show description', 'gallery-images-ape' ),
