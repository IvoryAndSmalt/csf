...
$menu_metabox->add_field( array(
	...
	'options'          => array(
		...
		'iconlabel' 	=> __( 'Icon and Label' , 	'gallery-images-ape' ),
	),
	'after_row'		=> '
		<div class="ape_menu_home_icon">',
	'before_row'		=> '
		<div class="alert alert-info" role="alert">
  			'.__('Home menu button settings', 'gallery-images-ape' )
  		.'</div>',
));

$menu_metabox->add_field( array(
    'name'    => __('Home icon','gallery-images-ape'),
...
$menu_metabox->add_field( array(
    'name'    => __('Home label','gallery-images-ape'),
...
$menu_metabox->add_field( array(
	'name' 			=> __('Current button', 'gallery-images-ape' ),
	...
	'before_row'		=> '
		<div class="alert alert-info" role="alert">
  			'.__("Category icon, for current gallery in top menu. Icon it's alternative for label on button.", 'gallery-images-ape' )
  		.'</div>',
	'after_row'			=> '
...
$menu_metabox->add_field( array(
    'name'    => __('Category icon','gallery-images-ape'),
    'default' => '',
    'id'	  => WPAPE_GALLERY_NAMESPACE .'menuLabel',
    'type'    => 'apeicon',
   	'info'		=> __("here you can define icon for top categories menu. This icon replace title on button. <br/>If this icon do not defined then you'll have just gallery title on button", 'gallery-images-ape'),
));
